...
import com.yuanlrc.movie.config.home.AlipayConfig;
...
public class Alipay {
	...
	public static String generatePayHtml(String sn,BigDecimal money,String title,String content){
		String html = null;
		//获得初始化的AlipayClient
